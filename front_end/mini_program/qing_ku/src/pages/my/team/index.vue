  ...
  <div class="my">
	<div class="header">
		...
		<div class="flex_center user_info">
			<img @click='to_login' class="default_head" src="../../../../static/imgs/default_head.png" alt="head" mode='widthFix' v-if='!my_data.head_pic'>
			<img @click='to_login' class="default_head" :src="'https://shop.technologyle.com' + my_data.head_pic" alt="head" mode='widthFix' v-if='my_data.head_pic'>
