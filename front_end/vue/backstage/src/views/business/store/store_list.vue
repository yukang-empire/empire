...
export default class store_list extends Vue{
    ...
    private send_data: any = {
        page: sessionStorage.getItem("store_list_page") ? sessionStorage.getItem("store_list_page") : 1,
        size: sessionStorage.getItem("store_list_size") ? sessionStorage.getItem("store_list_size") : 10,
        where: {
            keyword: sessionStorage.getItem("store_list_keyword") ? sessionStorage.getItem("store_list_keyword") : "",
            stime: sessionStorage.getItem("store_list_stime") ? sessionStorage.getItem("store_list_stime") : "",
            etime: sessionStorage.getItem("store_list_etime") ? sessionStorage.getItem("store_list_etime") : ""
        }
    };
    //需要展示的筛选功能
    ...
    search (val: any) {
        ...
        sessionStorage.setItem("store_list_keyword", val);
        this.store_list();
    };
    ...
    clear_search () {
        ...
        sessionStorage.setItem("store_list_keyword", "");
        this.store_list();
    };
    ...
    change_time(val: any) {
        ...
        sessionStorage.setItem("store_list_stime", this.send_data.where.stime);
        sessionStorage.setItem("store_list_etime", this.send_data.where.etime);
        this.store_list();
    };
