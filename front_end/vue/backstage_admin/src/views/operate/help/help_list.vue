...
export default class help_list extends Vue{
    //表格、页码数据
    private table_data: any = {
        ...
        page: {
            ...
            is_page: true,
            //当前页码
            current_page: sessionStorage.getItem("help_list_p") ? parseInt(sessionStorage.getItem("help_list_p")) : 1,
            //每页显示的数量
            size: sessionStorage.getItem("help_list_size") ? parseInt(sessionStorage.getItem("help_list_size")) : 10,
            sizes: [10, 15, 20],
            //总数量
            total: 0,
        }
    ...
    private send_data: any = {
        p: sessionStorage.getItem("help_list_p") ? sessionStorage.getItem("help_list_p") : 1,
        size: sessionStorage.getItem("help_list_size") ? sessionStorage.getItem("help_list_size") : 10,
        search: sessionStorage.getItem("help_list_search") ? sessionStorage.getItem("help_list_search") : "",
        start_time: sessionStorage.getItem("help_list_start_time") ? sessionStorage.getItem("help_list_start_time") : "",
        end_time: sessionStorage.getItem("help_list_end_time") ? sessionStorage.getItem("help_list_end_time") : "",
    };
    //需要展示的筛选功能
    ...
    //请求提现列表数据
    help_list () {
        this.$store.dispatch("help_list", this.send_data).then( (res: any) => {
    ...
    search (val: any) {
        ...
        this.send_data.p = 1;
        sessionStorage.setItem("help_list_p", "1");
        this.send_data.search = val;
        sessionStorage.setItem("help_list_search", val);
        this.help_list();
    };
    ...
    clear_search () {
        ...
        sessionStorage.setItem("help_list_search", "");
        this.help_list();
    };
    ...
    change_time(val: any) {
        ...
        sessionStorage.setItem("help_list_start_time", this.send_data.start_time);
        sessionStorage.setItem("help_list_end_time", this.send_data.end_time);
        this.help_list();
    };
    ...
    change_page(val: any) {
        ...
        sessionStorage.setItem("help_list_p", val);
        this.help_list();
    };
    ...
    change_page_size(val: any) {
        ...
        sessionStorage.setItem("help_list_size", val);
        this.help_list();
    };
