...
export default class receive_list extends Vue{
    ...
    private send_data: any = {
        ...
        current_state: sessionStorage.getItem("receive_list_state") ? parseInt(sessionStorage.getItem("receive_list_state")) : 0,
    };
    //需要展示的筛选功能
    ...
    //查看
    look_up (row: any) {
        this.$router.push({ path: '/order/receive/details', query: { club_id: row.id } });
    };
}
