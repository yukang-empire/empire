...
export default class service_list extends Vue{
    //表格、页码数据
    private table_data: any = {
        ...
        page: {
            ...
            is_page: true,
            //当前页码
            current_page: sessionStorage.getItem("service_list_p") ? parseInt(sessionStorage.getItem("service_list_p")) : 1,
            //每页显示的数量
            size: sessionStorage.getItem("service_list_size") ? parseInt(sessionStorage.getItem("service_list_size")) : 10,
            sizes: [10, 15, 20],
            //总数量
            total: 0,
        }
    ...
    private send_data: any = {
        p: sessionStorage.getItem("service_list_p") ? sessionStorage.getItem("service_list_p") : 1,
        size: sessionStorage.getItem("service_list_size") ? sessionStorage.getItem("service_list_size") : 10,
        search: sessionStorage.getItem("service_list_search") ? sessionStorage.getItem("service_list_search") : "",
        start_time: sessionStorage.getItem("service_list_start_time") ? sessionStorage.getItem("service_list_start_time") : "",
        end_time: sessionStorage.getItem("service_list_end_time") ? sessionStorage.getItem("service_list_end_time") : "",
        all_state: [
            {state: 0, name: "全部"},
            {state: 1, name: "待使用"},
            {state: 2, name: "已完成"},
        ...
        current_state: sessionStorage.getItem("service_list_state") ? parseInt(sessionStorage.getItem("service_list_state")) : 0,
    };
    //需要展示的筛选功能
    ...
    //请求service_list数据
    service_list () {
        this.$store.dispatch("service_list", this.send_data).then( (res: any) => {
    ...
    state_change (val) {
        ...
        this.send_data.p = 1;
        sessionStorage.setItem("service_list_p", "1");
        this.send_data.current_state = val;
        sessionStorage.setItem("service_list_state", val);
        this.service_list();
    };
    ...
    search (val: any) {
        ...
        sessionStorage.setItem("service_list_search", val);
        this.service_list();
    };
    ...
    clear_search () {
        ...
        sessionStorage.setItem("service_list_search", "");
        this.service_list();
    };
    ...
    change_time(val: any) {
        ...
        sessionStorage.setItem("service_list_start_time", this.send_data.start_time);
        sessionStorage.setItem("service_list_end_time", this.send_data.end_time);
        this.service_list();
    };
    ...
    change_page(val: any) {
        ...
        sessionStorage.setItem("service_list_p", val);
        this.service_list();
    };
    ...
    change_page_size(val: any) {
        ...
        sessionStorage.setItem("service_list_size", val);
        this.service_list();
    };
