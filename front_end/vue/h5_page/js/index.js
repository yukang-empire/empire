        ...
        methods: {
            ...
            copy_text () {
                ...
                clipboard.on('success', function(e) {
                    that.is_copy_suc = true;
                    setTimeout( () => {
                        that.is_copy_suc = false;
                    },1500);
                    e.clearSelection();
                });
            },
            ...
            //混合开发的h5拨打电话
            h5_call: function (tel) {
                //ios终端
                if (this.device_rele.is_ios) {
                    this.setupWebViewJavascriptBridge( bridge => {
                        //callPhone为事先与ios开发人员约好的函数名 tel为发送过去的数据 response为ios那边返回的数据
                        bridge.callHandler('callPhone', tel, function(response) {
                ...
                //android终端
                    ...
                    //callPhone为事先与android终端开发人员约好的函数名 tel为发送过去的数据(一般建议转成JSON.stringify字符串)
                    window.jsInterface.callPhone(tel);
                    return false;
                }else {
