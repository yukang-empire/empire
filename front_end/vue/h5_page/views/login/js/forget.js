    ...
    methods: {
        ...
        clear_input (name) {
            ...
            switch (name) {
                case 'account':
                    ...
                    break;
                case 'password':
                    this.verify_error('password', '请输入原密码！');
                    break;
                case 'new_password':
            ...
            switch (name) {
                ...
                case 'password':
                    if (!this.form_RE.password.test(this.form.password)) {
                        this.verify_error('password', '请输入6-16位数字与字母组成的原密码！');
                    }else {
                ...
                case 'new_password':
                    ...
                    }else if (this.form.new_password == this.form.password){
        ...
        find (name) {
            ...
            if (!is_RE) {
                ...
                var password_md5 = new_password.MD5(32);
                console.log('MD5(32位):', sign_md5);
                var find_para = {
                    mobile: account,
                    type: 'H5LOGIN',
