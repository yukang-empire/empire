        ...
        return {
            ...
            table_data: {
                ...
                table: {
                    ...
                    //表格数据
                    lists: [
                        {id: '6',operator: '康哥',modules: '订单管理',price: '1111',order: '8', address: '深圳', czsj: 1559214576, contents: '确认订单'},
                        {id: '7',operator: '康哥',modules: '订单管理',price: '2222',order: '8', address: '深圳', czsj: 1559214576, contents: '确认订单'},
                        {id: '8',operator: '康哥',modules: '订单管理',price: '3333',order: '8', address: '深圳', czsj: 1559215576, contents: '确认订单'},
                        {id: '9',operator: '康哥',modules: '订单管理',price: '4444',order: '8', address: '深圳', czsj: 1559316576, contents: '确认订单'},
                        {id: '10',operator: '康哥',modules: '订单管理',price: '5555',order: '8', address: '深圳', czsj: 1559417576, contents: '确认订单'},
                        {id: '11',operator: '康哥',modules: '订单管理',price: '6666',order: '8', address: '深圳', czsj: 1559518576, contents: '确认订单'},
                        {id: '12',operator: '康哥',modules: '订单管理',price: '7777',order: '8', address: '深圳', czsj: 1559619576, contents: '确认订单'},
                        {id: '13',operator: '康哥',modules: '订单管理',price: '8888',order: '8', address: '深圳', czsj: 1559714576, contents: '确认订单'},
                        {id: '14',operator: '康哥',modules: '订单管理',price: '9999',order: '8', address: '深圳', czsj: 1559814576, contents: '确认订单'},
                        {id: '15',operator: '康哥',modules: '订单管理',price: '10000',order: '8', address: '深圳', czsj: 1559914576, contents: '确认订单'},
                    ],
                    //需要改变的行开关状态
                    switch: {
                        index: null,
