...
new Vue({
    ...
    mounted: function () {
        ...
        //     contentType: false,
        //     processData: false,
        //     url: "http://api.map.baidu.com/geocoding/v3/?address=" + "广东省深圳市龙华区" + "&output=json&ak=" + "QM5TyraTXaaKcwKfw9qd8GyBBuoSWWLF" + "&callback=showLocation",
        //     dataType : "json",
        //     data: JSON.stringify(register_para),
        //     success: function (response) {
        //         console.log(response);
        //     }
        // });
        $.get("http://api.map.baidu.com/geocoding/v3/?address=广东省深圳市龙华区&output=json&ak=QM5TyraTXaaKcwKfw9qd8GyBBuoSWWLF&callback=showLocation", function(result){
            console.log(response);
        });
        //截图url里的邀请码
        var url = location.href;
        this.form_data.invi_code = url.substring(url.indexOf('first_leader=') + 13, url.indexOf('first_leader=') + 19);
